...
1. **Primária deve vir do CSV de keywords** (`seo/blog-keywords.csv`). Nunca inventa primária.
...
### 3. `lista de compras para casa nova` → `/blog/lista-de-compras-para-casa-nova`

- **Fonte primária:** ✓ CSV (vol 880, KD 16, Informational)
- **Usada na página:** `/blog/lista-de-compras-para-casa-nova`
- **Cluster:**

| Keyword secundária | Fonte |
|---|---|
| lista de compras casa nova | ✓ CSV (vol 720, KD 10) |
| lista de compras para casa | ✓ CSV (vol 1.300, KD 13) |
| o que comprar pra casa nova | (inventado) |
| lista de itens para casa nova | (inventado) |
| lista de compras de mudança | (inventado) |
...
1. Abre o `seo/blog-keywords.csv`
