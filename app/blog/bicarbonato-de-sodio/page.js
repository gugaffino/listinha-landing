...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/bicarbonato-de-sodio',
  },
  openGraph: {
    title: 'Bicarbonato de sódio: o que é, usos na cozinha e dicas',
    description: 'Bicarbonato de sódio serve para fermentar massas, amaciar carne, cozinhar feijão e limpar panelas. Saiba qual a diferença do fermento e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/bicarbonato-de-sodio',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/bicarbonato-de-sodio',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Bicarbonato de sódio', item: 'https://www.miseemcasa.com.br/blog/bicarbonato-de-sodio' },
  ],
}

export default function BicarbonataoDeSodio() {
  return (
    <>
      <script
