...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-alho',
  },
  openGraph: {
    title: 'Alho: o que é, benefícios e como usar na cozinha',
    description: 'Alho é um bulbo aromático da família da cebola. Saiba o que é, os tipos, como usar cru ou cozido, os benefícios comprovados e como guardar direito.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-alho',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-alho',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é alho', item: 'https://www.miseemcasa.com.br/blog/o-que-e-alho' },
  ],
}

export default function OQueEAlho() {
  return (
    <>
      <script
