...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-stevia',
  },
  openGraph: {
    title: 'O que é stevia: o adoçante natural da planta Stevia rebaudiana',
    description: 'Stevia é um adoçante natural 200 vezes mais doce que o açúcar, com zero calorias e índice glicêmico zero. Saiba o que é, de onde vem e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-stevia',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-stevia',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é stevia', item: 'https://www.miseemcasa.com.br/blog/o-que-e-stevia' },
  ],
}

export default function OQueEStevia() {
  return (
    <>
      <script
