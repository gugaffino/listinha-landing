...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-granola',
  },
  openGraph: {
    title: 'O que é granola: composição, tipos e como escolher',
    description: 'Granola é uma mistura de cereais torrados com oleaginosas e frutas secas. Saiba o que é, tipos, como consumir e o que olhar no rótulo antes de comprar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-granola',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-granola',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é granola', item: 'https://www.miseemcasa.com.br/blog/o-que-e-granola' },
  ],
}

export default function OQueEGranola() {
  return (
    <>
      <script
