...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-maca',
  },
  openGraph: {
    title: 'O que é maçã: tipos, calorias e como usar na cozinha',
    description: 'Maçã tem 56 kcal por 100g e é fonte de fibra solúvel e vitamina C. Conheça os tipos (fuji, gala, verde), qual usar na cozinha e se deve comer com casca.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-maca',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-maca',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é maçã', item: 'https://www.miseemcasa.com.br/blog/o-que-e-maca' },
  ],
}

export default function OQueEMaca() {
  return (
    <>
      <script
