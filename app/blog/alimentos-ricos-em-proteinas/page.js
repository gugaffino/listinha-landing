...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/alimentos-ricos-em-proteinas',
  },
  openGraph: {
    title: '10 alimentos ricos em proteínas para o dia a dia',
    description: 'Os 10 alimentos ricos em proteínas mais práticos para quem cozinha em casa: ovos, frango, feijão e mais. Quantidade por porção e como incluir sem complicar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/alimentos-ricos-em-proteinas',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/alimentos-ricos-em-proteinas',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: '10 alimentos ricos em proteínas', item: 'https://www.miseemcasa.com.br/blog/alimentos-ricos-em-proteinas' },
  ],
}

export default function AlimentosRicosEmProteinas() {
  return (
    <>
      <script
