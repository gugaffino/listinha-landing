...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/dieta-sem-acucar',
  },
  openGraph: {
    title: 'Dieta sem açúcar: o que comer, evitar e como fazer',
    description: 'Guia completo sobre dieta sem açúcar: alimentos permitidos, o que evitar no supermercado e como começar sem sofrimento. Dicas práticas para o dia a dia.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/dieta-sem-acucar',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/dieta-sem-acucar',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Dieta sem açúcar', item: 'https://www.miseemcasa.com.br/blog/dieta-sem-acucar' },
  ],
}

export default function DietaSemAcucar() {
  return (
    <>
      <script
