...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-cream-cheese',
  },
  openGraph: {
    title: 'O que é cream cheese: tipos, usos e diferença do requeijão',
    description: 'Cream cheese é um queijo cremoso macio com sabor levemente ácido, vindo dos EUA. Saiba o que é, tipos, como usar na cozinha e a diferença do requeijão.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-cream-cheese',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-cream-cheese',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é cream cheese', item: 'https://www.miseemcasa.com.br/blog/o-que-e-cream-cheese' },
  ],
}

export default function OQueECreamCheese() {
  return (
    <>
      <script
