...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/atum',
  },
  openGraph: {
    title: 'Atum: o que é, valor nutricional e como usar na cozinha',
    description: 'Atum tem 26g de proteína por 100g e ômega-3 de cadeia longa. Saiba o que é, a diferença entre sólido e ralado, em óleo ou água, e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/atum',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/atum',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Atum', item: 'https://www.miseemcasa.com.br/blog/atum' },
  ],
}

export default function Atum() {
  return (
    <>
      <script
