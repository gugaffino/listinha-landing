...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/beneficios-do-pepino',
  },
  openGraph: {
    title: 'Benefícios do pepino: tabela nutricional e como usar',
    description: 'Pepino tem 16 kcal por 100g e 95% de água. Conheça os benefícios para saúde, o valor nutricional completo, os tipos no Brasil e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/beneficios-do-pepino',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/beneficios-do-pepino',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Benefícios do pepino', item: 'https://www.miseemcasa.com.br/blog/beneficios-do-pepino' },
  ],
}

export default function BeneficiosDoPepino() {
  return (
    <>
      <script
