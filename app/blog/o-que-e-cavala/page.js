...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-cavala',
  },
  openGraph: {
    title: 'O que é cavala: o peixe com mais ômega-3 que o salmão',
    description: 'Cavala é um peixe azul com 5.100mg de ômega-3 por 100g — mais que o salmão. Saiba o que é, onde encontrar no mercado, como preparar e se vale na lista.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-cavala',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-cavala',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é cavala', item: 'https://www.miseemcasa.com.br/blog/o-que-e-cavala' },
  ],
}

export default function OQueECavala() {
  return (
    <>
      <script
