...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/feijao-preto-beneficios',
  },
  openGraph: {
    title: 'Feijão preto: benefícios, nutrição e como usar toda semana',
    description: 'Feijão preto é fonte de proteína vegetal, ferro e fibras em cada porção. Veja os benefícios, diferença do feijão carioca e como sempre ter na despensa.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/feijao-preto-beneficios',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/feijao-preto-beneficios',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Feijão preto: benefícios', item: 'https://www.miseemcasa.com.br/blog/feijao-preto-beneficios' },
  ],
}
