...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-chia',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é chia', item: 'https://www.miseemcasa.com.br/blog/o-que-e-chia' },
  ],
}

export default function OQueEChia() {
  return (
    <>
      <script
