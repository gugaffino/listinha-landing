...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/dieta-low-carb-cardapio',
  },
  openGraph: {
    title: 'Cardápio low carb para 7 dias: refeições prontas pra copiar',
    description: 'Cardápio low carb com 7 dias de refeições prontas para café da manhã, almoço e jantar. Inclui lista de compras e dicas para não abandonar na quarta-feira.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/dieta-low-carb-cardapio',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/dieta-low-carb-cardapio',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Cardápio low carb para 7 dias', item: 'https://www.miseemcasa.com.br/blog/dieta-low-carb-cardapio' },
  ],
}

export default function DietaLowCarbCardapio() {
  return (
    <>
      <script
