...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-amendoa',
  },
  openGraph: {
    title: 'Amêndoa: o que é, benefícios e como usar na cozinha',
    description:
      'Saiba o que é amêndoa, para que serve, quantas comer por dia, a diferença entre crua e torrada e como guardar em casa. O guia completo antes de comprar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-amendoa',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-amendoa',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://www.miseemcasa.com.br/blog/o-que-e-amendoa',
    },
  ],
}

export default function OQueEAmendoaPage() {
  return (
    <>
      <script
