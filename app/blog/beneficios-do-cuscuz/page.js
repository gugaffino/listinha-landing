...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/beneficios-do-cuscuz',
  },
  openGraph: {
    title: 'Benefícios do Cuscuz: Nutrição e Como Incluir na Rotina',
    description: 'Cuscuz de milho é rico em fibras, carboidratos complexos e selênio. Veja o que acontece com o seu corpo quando você inclui essa iguaria nordestina na semana.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/beneficios-do-cuscuz',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/beneficios-do-cuscuz',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Benefícios do cuscuz', item: 'https://www.miseemcasa.com.br/blog/beneficios-do-cuscuz' },
  ],
}

export default function BeneficiosDoCuscuz() {
  return (
    <>
      <script
