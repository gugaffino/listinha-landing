...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/arenque',
  },
  openGraph: {
    title: 'Arenque: o que é, benefícios e como usar o defumado',
    description: 'Arenque é primo da sardinha, mas com mais ômega-3 e vitamina D. Saiba o que é, onde comprar no Brasil, como usar o defumado e a diferença pra sardinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/arenque',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/arenque',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Arenque', item: 'https://www.miseemcasa.com.br/blog/arenque' },
  ],
}

export default function Arenque() {
  return (
    <>
      <script
