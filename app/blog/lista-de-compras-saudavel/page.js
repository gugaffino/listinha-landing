...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/lista-de-compras-saudavel',
  },
  openGraph: {
    title: 'Lista de compras saudável: guia completo e o que incluir',
    description: 'Lista de compras saudável organiza verduras, proteínas e grãos antes de ir ao mercado. Guia com categorias, custo por mês e dicas pra não sair do plano.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/lista-de-compras-saudavel',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/lista-de-compras-saudavel',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Lista de compras saudável', item: 'https://www.miseemcasa.com.br/blog/lista-de-compras-saudavel' },
  ],
}

export default function ListaDeComprasSaudavel() {
  return (
    <>
      <script
