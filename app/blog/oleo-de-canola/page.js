...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/oleo-de-canola',
  },
  openGraph: {
    title: 'Óleo de canola: o que é, para que serve e como usar',
    description: 'Óleo de canola tem ponto de fumaça de 204 °C, sabor neutro e baixo teor de gordura saturada. Saiba o que é, se faz mal e como usar certo na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/oleo-de-canola',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/oleo-de-canola',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Óleo de canola', item: 'https://www.miseemcasa.com.br/blog/oleo-de-canola' },
  ],
}

export default function OleoDeCanola() {
  return (
    <>
      <script
