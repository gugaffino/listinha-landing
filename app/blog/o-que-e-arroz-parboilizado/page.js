...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-arroz-parboilizado',
  },
  openGraph: {
    title: 'Arroz parboilizado: o que é, diferenças e como cozinhar',
    description: 'Arroz parboilizado passa por um pré-cozimento que preserva nutrientes do grão. Veja a diferença do branco e integral, como cozinhar e quando vale comprar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-arroz-parboilizado',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-arroz-parboilizado',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é arroz parboilizado', item: 'https://www.miseemcasa.com.br/blog/o-que-e-arroz-parboilizado' },
  ],
}

export default function OQueEArrozParboilizado() {
  return (
    <>
      <script
