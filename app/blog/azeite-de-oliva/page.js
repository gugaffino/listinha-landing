...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/azeite-de-oliva',
  },
  openGraph: {
    title: 'Azeite de oliva extra virgem: benefícios e como usar',
    description: 'Azeite de oliva extra virgem tem gorduras insaturadas e ação anti-inflamatória comprovada. Veja os tipos, como usar, quanto consumir por dia e como guardar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/azeite-de-oliva',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/azeite-de-oliva',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Azeite de oliva', item: 'https://www.miseemcasa.com.br/blog/azeite-de-oliva' },
  ],
}

export default function AzeiteDeOliva() {
  return (
    <>
      <script
