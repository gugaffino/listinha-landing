...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-pao-branco',
  },
  openGraph: {
    title: 'Pão branco: o que é, calorias e como escolher no mercado',
    description: 'Pão branco é feito de farinha refinada — menos fibra, índice glicêmico mais alto. Saiba quantas calorias tem, o que muda pro integral e como escolher bem.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-pao-branco',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-pao-branco',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é pão branco', item: 'https://www.miseemcasa.com.br/blog/o-que-e-pao-branco' },
  ],
}

export default function OQueEPaoBranco() {
  return (
    <>
      <script
