...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/alcaparras',
  },
  openGraph: {
    title: 'Alcaparras: o que são, como usar e onde comprar no Brasil',
    description: 'Alcaparras são os botões florais do Mediterrâneo, conservados em salmoura ou sal grosso. Saiba o que são, como usar em receitas e onde encontrar no Brasil.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/alcaparras',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/alcaparras',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Alcaparras', item: 'https://www.miseemcasa.com.br/blog/alcaparras' },
  ],
}

export default function AlcaparrasPost() {
  return (
    <>
      <script
