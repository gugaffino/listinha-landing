...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-raiz-forte',
  },
  openGraph: {
    title: 'Raiz forte: o que é, para que serve e como usar na cozinha',
    description: 'Raiz forte é a raiz picante usada ralada em molho com carnes e peixes defumados. Saiba a diferença do wasabi, como usar na cozinha e onde comprar no Brasil.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-raiz-forte',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-raiz-forte',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é raiz forte', item: 'https://www.miseemcasa.com.br/blog/o-que-e-raiz-forte' },
  ],
}

export default function OQueERaizForte() {
  return (
    <>
      <script
