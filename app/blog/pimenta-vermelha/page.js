...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/pimenta-vermelha',
  },
  openGraph: {
    title: 'Pimenta vermelha: tipos, benefícios e como usar na cozinha',
    description: 'Pimenta vermelha cobre desde o pimentão doce até a caiena e a malagueta. Conheça os tipos, os benefícios da capsaicina e como usar cada variedade.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/pimenta-vermelha',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/pimenta-vermelha',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Pimenta vermelha', item: 'https://www.miseemcasa.com.br/blog/pimenta-vermelha' },
  ],
}

export default function PimentaVermelha() {
  return (
    <>
      <script
