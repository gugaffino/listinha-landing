...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-mirtilo',
  },
  openGraph: {
    title: 'O que é mirtilo: tipos, benefícios e se vale o preço',
    description: 'Mirtilo é o blueberry europeu — pequeno, azul e rico em antioxidantes. Saiba o que é, os benefícios comprovados, como usar na cozinha e onde comprar no Brasil.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-mirtilo',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-mirtilo',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é mirtilo', item: 'https://www.miseemcasa.com.br/blog/o-que-e-mirtilo' },
  ],
}

export default function OQueEMirtilo() {
  return (
    <>
      <script
