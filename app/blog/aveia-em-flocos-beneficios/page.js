...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/aveia-em-flocos-beneficios',
  },
  openGraph: {
    title: 'Aveia em flocos: benefícios e como usar na cozinha',
    description: 'Aveia em flocos tem betaglucana, fibra que reduz colesterol LDL e controla glicemia. Saiba os benefícios e como incluir aveia na rotina semanal de cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/aveia-em-flocos-beneficios',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/aveia-em-flocos-beneficios',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Aveia em flocos: benefícios', item: 'https://www.miseemcasa.com.br/blog/aveia-em-flocos-beneficios' },
  ],
}

export default function AveiaEmFlocosPage() {
  return (
    <>
      <script
