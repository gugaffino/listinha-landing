...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/beneficios-do-rabanete',
  },
  openGraph: {
    title: 'Benefícios do rabanete: o que é e como usar na cozinha',
    description: 'Rabanete tem vitamina C, fibra e apenas 16 kcal por 100g. Saiba os benefícios, o valor nutricional e como usar esse legume barato na cozinha sem desperdício.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/beneficios-do-rabanete',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/beneficios-do-rabanete',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Benefícios do rabanete', item: 'https://www.miseemcasa.com.br/blog/beneficios-do-rabanete' },
  ],
}

export default function BeneficiosDoRabanete() {
  return (
    <>
      <script
