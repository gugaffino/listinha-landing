...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/batata-doce',
  },
  openGraph: {
    title: 'Batata doce: o que é, nutrientes e como usar na cozinha',
    description: 'Batata doce é um tubérculo com betacaroteno, fibras e carboidratos de baixo índice glicêmico. Veja tipos, valor nutricional e como guardar e usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/batata-doce',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/batata-doce',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Batata doce', item: 'https://www.miseemcasa.com.br/blog/batata-doce' },
  ],
}

export default function BatataDoce() {
  return (
    <>
      <script
