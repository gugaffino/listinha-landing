...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/blog/o-que-e-nabo',
  },
  openGraph: {
    title: 'Nabo: o que é, para que serve e como usar na cozinha',
    description: 'Nabo é um legume raiz pouco usado no Brasil, com apenas 35 calorias por 100g, vitamina C e fibras. Descubra o que é, para que serve e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/blog/o-que-e-nabo',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/blog/o-que-e-nabo',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é nabo', item: 'https://www.miseemcasa.com.br/blog/o-que-e-nabo' },
  ],
}

export default function OQueENabo() {
  return (
    <>
      <script
