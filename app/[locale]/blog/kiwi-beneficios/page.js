...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/kiwi-beneficios',
  },
  openGraph: {
    title: 'Kiwi: benefícios, nutrientes e como escolher no mercado',
    description: 'Kiwi tem mais vitamina C que a laranja, actinidina para digestão e apenas 61 kcal por 100g. Veja os benefícios, os tipos disponíveis no Brasil e como guardar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/kiwi-beneficios',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/kiwi-beneficios',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Kiwi: benefícios e nutrientes', item: 'https://www.miseemcasa.com.br/pt/blog/kiwi-beneficios' },
  ],
}

export default function KiwiBeneficios({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
