...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/lista-de-compras-mercado',
  },
  openGraph: {
    title: 'Lista de compras mercado: como organizar e gastar menos',
    description: 'Lista de compras para o mercado organizada por categoria. Hortifruti, carnes, laticínios, limpeza: guia completo com dicas para gastar menos no supermercado.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/lista-de-compras-mercado',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/lista-de-compras-mercado',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Lista de compras mercado', item: 'https://www.miseemcasa.com.br/pt/blog/lista-de-compras-mercado' },
  ],
}

export default function ListaDeComprasMercado({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
