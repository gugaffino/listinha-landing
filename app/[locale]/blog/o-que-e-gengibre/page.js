...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/o-que-e-gengibre',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é gengibre', item: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-gengibre' },
  ],
}

export default function OQueEGengibre({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
