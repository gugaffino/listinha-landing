...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/para-que-serve-o-oregano',
  },
  openGraph: {
    title: 'Para que serve o orégano: usos, fresco, seco e como guardar',
    description: 'Para que serve o orégano além da pizza? Saiba as diferenças entre fresco e seco, quanto usar em receitas e como guardar em casa sem perder o aroma todo.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/para-que-serve-o-oregano',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/para-que-serve-o-oregano',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para que serve o orégano', item: 'https://www.miseemcasa.com.br/pt/blog/para-que-serve-o-oregano' },
  ],
}

export default function ParaQueServeOOregano({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
