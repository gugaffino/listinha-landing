...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-margarina',
  },
  openGraph: {
    title: 'Margarina: o que é, diferença da manteiga e quando usar',
    description: 'Margarina é feita de óleos vegetais hidrogenados. Saiba o que é, a diferença da manteiga, o que mudou na gordura trans e quando usar cada uma em receitas.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-margarina',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/o-que-e-margarina',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é margarina', item: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-margarina' },
  ],
}

export default function OQueEMargarina({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
