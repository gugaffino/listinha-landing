...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-avela',
  },
  openGraph: {
    title: 'Avelã: o que é, para que serve e como usar na cozinha',
    description:
      'Avelã é uma oleaginosa rica em vitamina E e gorduras boas — a mesma da pasta de Nutella. Saiba o que é, benefícios, quantas comer e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-avela',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/o-que-e-avela',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-avela',
    },
  ],
}

export default function OQueEAvela({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
