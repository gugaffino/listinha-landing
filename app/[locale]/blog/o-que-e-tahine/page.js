...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-tahine',
  },
  openGraph: {
    title: 'O que é tahine: pasta de gergelim, tipos e como usar',
    description: 'Tahine é pasta de gergelim puro. Saiba o que é tahine, a diferença entre branco e preto, como usar no homus, molhos e saladas — e se vale colocar na lista.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-tahine',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/o-que-e-tahine',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é tahine', item: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-tahine' },
  ],
}

export default function OQueETahine({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
