...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/cardamomo-para-que-serve',
  },
  openGraph: {
    title: 'Cardamomo para que serve: tipos, usos e benefícios',
    description: 'Cardamomo é uma especiaria de aroma intenso e sabor único, usada em chás, doces e pratos árabes. Saiba para que serve, tipos e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/cardamomo-para-que-serve',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/cardamomo-para-que-serve',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Cardamomo para que serve', item: 'https://www.miseemcasa.com.br/pt/blog/cardamomo-para-que-serve' },
  ],
}

export default function CardamomoParaQueServe({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
