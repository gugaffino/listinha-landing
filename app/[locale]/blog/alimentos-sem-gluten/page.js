...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/alimentos-sem-gluten',
  },
  openGraph: {
    title: 'Alimentos sem glúten: lista completa para o mercado',
    description: 'Arroz, milho, batata, legumes e carnes frescas são naturalmente sem glúten. Veja lista completa, o que evitar e como ler o rótulo na hora da compra.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/alimentos-sem-gluten',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/alimentos-sem-gluten',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Alimentos sem glúten', item: 'https://www.miseemcasa.com.br/pt/blog/alimentos-sem-gluten' },
  ],
}

export default function AlimentosSemGluten({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
