...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/cardapio-semanal-simples-caseiro',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Cardápio semanal simples caseiro', item: 'https://www.miseemcasa.com.br/pt/blog/cardapio-semanal-simples-caseiro' },
  ],
}

export default function CardapioSemanalSimplesCaseiro({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
