...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/beneficios-da-cebola-roxa',
  },
  openGraph: {
    title: 'Benefícios da cebola roxa: nutrientes e como usar na cozinha',
    description: 'Cebola roxa tem antocianinas e quercetina que a amarela não tem. Veja os benefícios confirmados, se perde com o cozimento e como usar mais na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/beneficios-da-cebola-roxa',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/beneficios-da-cebola-roxa',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Benefícios da cebola roxa', item: 'https://www.miseemcasa.com.br/pt/blog/beneficios-da-cebola-roxa' },
  ],
}

export default function BeneficiosDaCebolaRoxa({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
