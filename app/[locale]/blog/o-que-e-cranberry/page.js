...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/o-que-e-cranberry',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é cranberry', item: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-cranberry' },
  ],
}

export default function OQueECranberry({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
