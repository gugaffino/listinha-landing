...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/dieta-carnivora',
  },
  openGraph: {
    title: 'Dieta carnívora: o que é, alimentos e como começar',
    description: 'A dieta carnívora elimina plantas e mantém só alimentos de origem animal. Veja o que comer, o que cortar, cardápio de 7 dias e os riscos que precisa conhecer.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/dieta-carnivora',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/dieta-carnivora',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Dieta carnívora', item: 'https://www.miseemcasa.com.br/pt/blog/dieta-carnivora' },
  ],
}

export default function DietaCarnivora({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
