...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/como-economizar-no-mercado',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Como economizar no mercado', item: 'https://www.miseemcasa.com.br/pt/blog/como-economizar-no-mercado' },
  ],
}

export default function ComoEconomizarNoMercado({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
