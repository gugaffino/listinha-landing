...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-ricota',
  },
  openGraph: {
    title: 'Ricota: o que é, diferença do cottage e como usar',
    description: 'Ricota é feita do soro do leite, não do leite em si. Saiba o que é, a diferença do cottage e requeijão, o valor nutricional e como usar na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-ricota',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/o-que-e-ricota',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'O que é ricota', item: 'https://www.miseemcasa.com.br/pt/blog/o-que-e-ricota' },
  ],
}

export default function OQueERicota({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
