...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/frutas-citricas',
  },
  openGraph: {
    title: 'Frutas cítricas: quais são, benefícios e como usar',
    description: 'Laranja, limão, tangerina, pomelo: quais são as frutas cítricas, os benefícios da vitamina C e como usar na cozinha com dicas para comprar no mercado.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/frutas-citricas',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/frutas-citricas',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Frutas cítricas', item: 'https://www.miseemcasa.com.br/pt/blog/frutas-citricas' },
  ],
}

export default function FrutasCitricas({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
