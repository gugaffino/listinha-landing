...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/damascos-secos',
  },
  openGraph: {
    title: 'Damascos secos: o que são, benefícios e como usar na cozinha',
    description: 'Damasco seco é o damasco fresco desidratado — concentra ferro, potássio e betacaroteno. Veja o que é, os benefícios reais e como usar além do chazinho.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/damascos-secos',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/damascos-secos',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Damascos secos', item: 'https://www.miseemcasa.com.br/pt/blog/damascos-secos' },
  ],
}

export default function DamascosSecos({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
