...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/quinoa-para-que-serve',
  },
  openGraph: {
    ...
    description:
      'Quinoa é um pseudocereal com proteína vegetal completa, fibras e sem glúten. Descubra para que serve, como cozinhar sem ficar amargo e os benefícios reais.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/quinoa-para-que-serve',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/quinoa-para-que-serve',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://www.miseemcasa.com.br/pt/blog/quinoa-para-que-serve',
    },
  ],
}

export default function QuinoaParaQueServe({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
