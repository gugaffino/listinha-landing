...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.miseemcasa.com.br/pt/blog/abobrinha-calorias' },
  openGraph: {
    title: 'Abobrinha: calorias, valor nutricional e benefícios',
    description: 'Abobrinha tem 17 kcal por 100g, baixo carboidrato e é uma das hortaliças mais versáteis da cozinha brasileira. Tabela nutricional, tipos e como guardar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/abobrinha-calorias',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/abobrinha-calorias',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Abobrinha: calorias, valor nutricional e benefícios', item: 'https://www.miseemcasa.com.br/pt/blog/abobrinha-calorias' },
  ],
}

export default function AbobrinhaCaloriasPage({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
