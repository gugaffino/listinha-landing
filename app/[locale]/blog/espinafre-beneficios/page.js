...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/espinafre-beneficios',
  },
  openGraph: {
    title: 'Espinafre: benefícios, valor nutricional e como usar',
    description: 'Espinafre tem 23 kcal por 100g e vitamina K acima de 400% do VD. Conheça os benefícios, o que muda entre cru e cozido e como usar de verdade na cozinha.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/espinafre-beneficios',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/espinafre-beneficios',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Benefícios do espinafre', item: 'https://www.miseemcasa.com.br/pt/blog/espinafre-beneficios' },
  ],
}

export default function EspinafreBeneficios({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
