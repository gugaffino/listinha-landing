...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.miseemcasa.com.br/pt/blog/oleo-de-gergelim',
  },
  openGraph: {
    title: 'Óleo de gergelim: benefícios e como usar na cozinha',
    description: 'Óleo de gergelim tem benefícios para coração, pele e inflamação. Entenda a diferença entre cru e torrado, como comprar e como usar na cozinha sem errar.',
    type: 'article',
    url: 'https://www.miseemcasa.com.br/pt/blog/oleo-de-gergelim',
    images: [
      {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/oleo-de-gergelim',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Óleo de gergelim', item: 'https://www.miseemcasa.com.br/pt/blog/oleo-de-gergelim' },
  ],
}

export default function OleoDeGergelim({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
