...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.miseemcasa.com.br/pt/blog/como-organizar-a-despensa',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Como organizar a despensa', item: 'https://www.miseemcasa.com.br/pt/blog/como-organizar-a-despensa' },
  ],
}

export default function ComoOrganizarADespensa({ params }) {
  const { locale } = params
  if (locale !== 'pt') {
    notFound()
  }
      ...
      <main id="main-content" className="blog-page">
        ...
        <article className="prose">
          ...
          <div className="blog-cta reveal">
            <h2>
              Despensa organizada.<br /><em>Lista automática. Grátis.</em>
            </h2>
